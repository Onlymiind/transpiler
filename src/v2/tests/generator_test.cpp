...
TEST_CASE("generator: casts", "[generator]") {
    std::vector<GeneratorTestCase> cases{
        {"bool(true)", "int result = (int)1"},
        {"u64(1.1)", "uint64_t result = (uint64_t)1.1"},
        {"f64(1)", "double result = (double)1"},
        {"u64(-1.1)", "uint64_t result = (uint64_t)-(double)1.1"},
        {"bool(!false)", "int result = (int)!(int)0"},
        {"f64(1 / 2)", "double result = (double)((uint64_t)1 / (uint64_t)2"},
        {"u64(1.1 * 2.2)", "uint64_t result = (uint64_t)((double)1.1 * (double)2.2)"},
        {"bool(true == false)", "int result = (int)((int)1 == (int)0)"},
    };
...
TEST_CASE("generator: expressions", "[generator]") {
    std::vector<GeneratorTestCase> cases{
        ...
        {"f64(1 + 2 * u64(1.3 - 11.02 * f64(12)) /1000)",
         "double result = (double)((uint64_t)1 + (((uint64_t)2 * (uint64_t)((double)1.3 - ((double)11.02 * (double)12))) / (uint64_t)1000))"},
    };
