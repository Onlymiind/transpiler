...
namespace common {
    ...
    class BreakStatement final : public Statement {
      public:
        BreakStatement(size_t pos) : Statement(static_kind(), pos, true) {}
    ...
    class ErrorStatement final : public Statement {
      public:
        ErrorStatement(size_t pos) : Statement(static_kind(), pos, true) {}
    ...
    class ContinueStatement final : public Statement {
      public:
        ContinueStatement(size_t pos) : Statement(static_kind(), pos, true) {}
    ...
    class Branch final : public Statement {
      public:
        Branch(std::unique_ptr<Expression> &&predicate, Block &&true_branch,
               std::optional<Block> &&false_branch, size_t pos)
    ...
    class Loop final : public Statement {
      public:
        Loop(size_t pos) : Statement(static_kind(), pos, true), body_(pos) {}
